...
public interface SyntaxTreeConstants {
  ...
  int  NULL_ID =  327;
  int  N_ActDecl  =  328 ; //TBC check what does this mean?
  int  N_ActionExpr  =  329 ; //TBC check what does this mean?
...
//  int  N_ChooseStatement  =  339 ;  // Removed by LL 25 Jul 2007
  int  N_ConjItem  =  340 ; //TBC
  int  N_ConjList  =  341 ; //TBC
  int  N_ConsDecl  =  342 ; //TBC
  int  N_DisjItem  =  343 ; //TBC
  int  N_DisjList  =  344 ; //TBC
  int  N_EndModule  =  345 ;
  int  N_Except  =  346 ;
  ...
  int  N_FieldSet  =  354 ;
  int  N_FieldVal  =  355 ;
  int  N_FunctionDefinition  =  356 ; //TBC check what does this mean?
  int  N_FunctionParam  =  357 ; //TBC check what does this mean?
  int  N_GeneralId  =  358 ;
